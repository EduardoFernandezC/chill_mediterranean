...
tmap_save(figure_1, "figures/final_figures/figure_1B.png", width = 17.6, height = 23.4 / 2, units = "cm", dpi = 600)
...
tmap_save(figure_2, "figures/final_figures/figure_2B.png", width = 17.6, height = 23.4, units = "cm", dpi = 600)
...
tmap_save(figure_3, "figures/final_figures/figure_3B.png", width = 17.6, height = 23.4, units = "cm", dpi = 600)
